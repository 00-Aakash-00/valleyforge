		...
		<section className="relative flex min-h-screen items-center bg-vfw-navy-900">
			...
			<div className="relative z-10 mx-auto w-full max-w-7xl px-4 py-32 sm:px-6 lg:px-8">
				<div className="max-w-2xl text-center lg:text-left">
					...
					<h1 className="font-heading text-4xl font-extrabold leading-[1.1] text-white sm:text-5xl md:text-6xl lg:text-7xl">
					...
					<div className="mt-10 flex flex-col gap-4 sm:flex-row">
						...
						<a
							href="#contact"
							className="inline-flex min-h-[48px] items-center justify-center rounded-full border-2 border-white/30 px-8 py-3 font-semibold uppercase tracking-wider text-white transition-colors hover:border-white/60 hover:bg-white/10"
						>
							Send Us a Message
						</a>
					</div>
