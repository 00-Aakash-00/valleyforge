				...
				<DashedBorderBox variant="dark">
					<div className="grid items-center gap-10 lg:grid-cols-5 lg:gap-16">
						<div className="lg:col-span-3">
							...
							<p className="mt-4 max-w-xl text-lg text-white/70">{description}</p>
							<div className="mt-8 flex flex-col gap-4 sm:flex-row">
								...
								<a
									...
									className="inline-flex min-h-[48px] items-center justify-center gap-2 rounded-full border-2 border-white/30 px-8 py-3 font-semibold uppercase tracking-wider text-white transition-colors hover:border-white/60 hover:bg-white/10"
								>
