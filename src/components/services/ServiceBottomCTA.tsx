				...
				<DashedBorderBox variant="light">
					<div className="grid items-center gap-10 lg:grid-cols-5 lg:gap-16">
						<div className="lg:col-span-3">
							<h2 className="font-heading text-2xl font-bold leading-tight text-vfw-navy-900 sm:text-3xl md:text-4xl lg:text-5xl">
								{heading} <span className="text-vfw-red-600">{headingAccent}</span>
							</h2>
							<p className="mt-4 max-w-xl text-base text-vfw-navy-900/70 sm:text-lg">
								{description}
							</p>
							<div className="mt-8 flex flex-col gap-4 sm:flex-row">
								...
								<a
									...
									className="inline-flex min-h-[48px] w-full items-center justify-center gap-2 rounded-full border-2 border-vfw-navy-700 px-8 py-3 font-semibold uppercase tracking-wider text-vfw-navy-900 transition-colors hover:border-vfw-navy-900 hover:bg-vfw-navy-900/10 sm:w-auto"
								>
						...
						<div className="lg:col-span-2">
							...
							<p className="mt-3 text-vfw-navy-900/60">{accentDescription}</p>
						</div>
					</div>
				</DashedBorderBox>
			</Container>
